...
export function AppPagination({ page, pageSize, totalCount }: Props) {
  ...
  return (
    <Pagination className="fixed flex items-center justify-between px-10 max-w-none inset-x-0 bottom-0 z-50 w-full border-t border-border/70 bg-background/70 py-2 backdrop-blur-2xl">
